...
while ($bilgilerimCek=$bilgilerimiSor->fetch(PDO::FETCH_ASSOC)) {?>
	...
	<tr>
		...
		<td align="center"><a href="duzenle.php?id=<?php echo $bilgilerimCek["id"]?>"><button>Düzenle</button></td></a> 
		<!--id gönderirken dikkat et burada verdiğim isimle yakalıyorum öbür tarafta (düzenle.php de dbden id alıyoruz takma ad "id" olarak veriyorum ):)-->
		<!--İd gönderdik-->
		<td align="center"><a href="islem.php?bilgilerimSil=ok&id=<?php echo $bilgilerimCek["id"]?> "><button>Sil</button></td></a> 
